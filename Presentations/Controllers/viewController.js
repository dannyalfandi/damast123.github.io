...
exports.getResumePage = catchAsync(async (req, res, next) => {
  const contentWork5 =
    req.t("resume_page.content_work_5", { returnObjects: true }) || [];
  const contentWork4 =
    req.t("resume_page.content_work_4", { returnObjects: true }) || [];
  const contentWork3 =
    req.t("resume_page.content_work_3", { returnObjects: true }) || [];
  const contentWork2 =
    req.t("resume_page.content_work_2", { returnObjects: true }) || [];
  const contentWork1 =
    req.t("resume_page.content_work_1", { returnObjects: true }) || [];
